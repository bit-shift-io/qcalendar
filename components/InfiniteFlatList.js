...
// https://github.com/clauderic/react-native-infinite-calendar
...
*/
    ...
    let min = 1983; //this._min.getFullYear();
    let max = 2050; //this._max.getFullYear();
    ...
    for (let year = min; year <= max; year++) {
      for (let month = 0; month < 12; month++) {
        ...
        const height = 4 /*getWeeksInMonth(month, year)*/ * props.rowHeight;
